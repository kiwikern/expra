...
function main() {
    testing_internal_1.describe('Expense component', function () {
        testing_internal_1.it('should work', testing_internal_1.injectAsync([testing_internal_1.TestComponentBuilder], function (tcb) {
            return tcb.overrideTemplate(TestComponent, '<div><expense></expense></div>')
                ...
                testing_internal_1.expect(dom_adapter_1.DOM.querySelectorAll(homeDOMEl, 'h1')[0].textContent).toEqual('Expense');
            });
        }));
    });
}
...
var TestComponent = (function () {
    ...
    TestComponent = __decorate([
        ...
        core_1.View({ directives: [expense_1.ExpenseCmp] }), 
        __metadata('design:paramtypes', [])
    ], TestComponent);
    return TestComponent;
})();
//# sourceMappingURL=expense_spec.js.map